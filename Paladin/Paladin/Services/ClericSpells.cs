...
namespace Paladin.Services
{
    ...
    {
        public static async Task FillTempest()
        {
            ...
            var answer = await App.Current.MainPage.DisplayAlert("Внимание", "Список заклинаний домена Кузни успешно обновлен", null, "Ок");
        }

        public static async Task FillForge()
        {
            var ForgeDomain = new List<SpellItem>
            {
                new SpellItem
                {
                    ClassSpell = true,
                ...
                new SpellItem
                {
                    ...
                    Level = 5,
                    School = "5 уровень, преобразование",
                    Time = "1 действие",
                    Distance = "120 футов",
                    Components = "В, С",
                    Duration = "Концентрация, вплоть до 1 минуты",
                    ...
                    "• Крошечный. Хиты(20), КД(18), Атака(+8 к атаке, урон 1к4 + 4), Сил(4), Лов(18)\n" +
                    "• Маленький. Хиты(25), КД(16), Атака(+6 к атаке, урон 1к8 + 2), Сил(6), Лов(14)\n" +
                    "• Средний. Хиты(40), КД(13), Атака(+5 к атаке, урон 2к6 + 1), Сил(10), Лов(12)\n" +
                    "• Большой. Хиты(50), КД(10), Атака(+6 к атаке, урон 2к10 + 2), Сил(14), Лов(10)\n" +
                    "• Огромный. Хиты(80), КД(10), Атака(+8 к атаке, урон 2к12 + 4), Сил(18), Лов(6)\n" +
                ...
                new SpellItem
                {
                    ...
                    Title = "Сотворение",
                    Level = 5,
                    School = "5 уровень, иллюзия",
                    Time = "1 минута",
                    Distance = "30 футов",
                    Components = "В, С, М (крошечный кусочек материи того же вида, из которого вы планируете создать предмет)",
                    Duration = "Особая",
                    Description = "Вы зачерпываете теневую материю в Царстве Теней и создаёте в пределах дистанции неживой предмет из растительной материи: ткань, верёвку, дерево, или что-то подобное. Вы также можете этим заклинанием создавать минеральную материю, такую как камни, кристаллы и металлы. Создаваемый предмет должен помещаться в куб с длиной ребра 5 футов, и должен иметь форму и материю, которые вы раньше видели. Длительность зависит от создаваемого материала. Если предмет составлен из нескольких материалов, используется самая короткая длительность.\n" +
            ...
            await App.Database.FillSpellBase(ForgeDomain);
            var answer = await App.Current.MainPage.DisplayAlert("Внимание", "Список заклинаний домена Бури успешно обновлен", null, "Ок");
        }
